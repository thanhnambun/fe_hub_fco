...
const projects = [
  {
    ...
    before:
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop&q=80&blur=20",
  ...
  },
  {
    ...
    before:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop&q=80&blur=20",
    after: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&q=80",
  },
  {
    id: 3,
    ...
    before:
      "https://images.unsplash.com/photo-1500634148414-437df07f56e3?w=200&h=200&fit=crop&q=80&blur=20",
    after: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&q=80",
  },
  {
    id: 4,
    ...
    before:
      "https://images.unsplash.com/photo-1495604653989-0e612f1e1475?w=200&h=200&fit=crop&q=80&blur=20",
    after: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&q=80",
  },
];
  ...
  return (
    <div className="glass-effect p-8 rounded-xl">
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h3 className="text-xl font-serif font-bold text-foreground mb-2">Project Snapshot</h3>
          ...
          {projects.map((project) => (
            <div key={project.id} className="group relative cursor-pointer">
              <div className="relative w-full aspect-square rounded-lg overflow-hidden border-2 border-primary/40 hover:border-primary/80 transition-all duration-300">
                ...
                {/* After Image */}
                <div className="absolute inset-0 right-0 h-full w-1/2 overflow-hidden">
                  <Image
                    src={project.after}
